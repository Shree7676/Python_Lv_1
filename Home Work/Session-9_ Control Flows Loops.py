Homework
    ...
    class . He said to create a word that contains vowels.The student who will write a meaningful word with the maximum number of vowels present in it will win the challenge.There were around 30 students in the class and each student was trying to create the word multiple times.So Subh decided to create a python program that can take words as input and can print the number of vowels present in the word.But Shubh doesn’t know how to use for loop in python.Help Shubh to create a program that can print the number of vowels present in the word.
